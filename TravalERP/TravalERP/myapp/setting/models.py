...
class CommonCode(models.Model):
    ...
    parent_code = models.CharField(db_column='PARENT_CODE', max_length=10)  # Field name made lowercase.
    code_name = models.CharField(db_column='CODE_NAME', max_length=1000)  # Field name made lowercase.
    code_name_en = models.CharField(db_column='CODE_NAME_EN', max_length=1000)  # Field name made lowercase.
...
class Users(models.Model):
    ...
    pw = models.CharField(db_column='PW', max_length=100)  # Field name made lowercase.
    agency_code = models.CharField(db_column='AGENCY_CODE', max_length=10)  # Field name made lowercase.
    kubun = models.CharField(db_column='KUBUN', max_length=1)  # Field name made lowercase.
    name = models.CharField(db_column='NAME', max_length=20)  # Field name made lowercase.
    tel = models.CharField(db_column='TEL', max_length=13)  # Field name made lowercase.
    messenger = models.CharField(db_column='MESSENGER', max_length=100)  # Field name made lowercase.
    email = models.CharField(db_column='EMAIL', max_length=100)  # Field name made lowercase.
    remark = models.CharField(db_column='REMARK', max_length=1000)  # Field name made lowercase.
